...
<AuthorNotes heading={"Playground Limitations"} variant={"warning"}>
    ...
    - You cannot navigate to other websites like Facebook as the navigation bar will stop working and the preview frame
    will not load due to security reasons.
    ...
    Don't worry! You'll learn to use another IDE called Visual Studio Code in the course that offers a much more
    complete experience than this playground.
</AuthorNotes>
