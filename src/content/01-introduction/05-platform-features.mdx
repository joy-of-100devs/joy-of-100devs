...
<CodePlayground repository={"/01/05/preview-playground"}></CodePlayground>
...
<AuthorNotes heading={"Playground Limitations"} variant={"warning"}>
    The code playgrounds are powered by Sandpack, which is meant to be a lightweight technology to run code snippets on the web.
